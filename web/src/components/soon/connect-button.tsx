...
export default function ConnectButton() {
  ...
  return (
    <UnifiedWalletButton
      currentUserClassName="!focus:outline-none outline-none !hover:bg-blue-800 !focus:ring-4 !px-5 !py-3 !text-lg font-normal border border-black !border-opacity-[12%]  !h-10 !rounded-md"
